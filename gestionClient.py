...
class MenuWindow(Gtk.Window):
    ...
    def __init__(self):
        ...
        AjoutClient_button.connect("clicked", self.ouvrir_gestion_AjoutClient)
        Retour_button.connect("clicked", self.ouvrir_retour)

    def ouvrir_gestion_ListClient(self, widget):
        os.system('python ListeCLient.py')

    def ouvrir_gestion_SuppClient(self, widget):
        os.system('python SuppressionClient.py')

    def ouvrir_gestion_AjoutClient(self, widget):
        os.system('python AjouterClient.py')
